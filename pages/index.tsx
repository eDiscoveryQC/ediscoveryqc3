...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white px-6 py-12">
      ...
      {/* Preview of QC Tools Section */}
      <div id="qc-tools" className="max-w-7xl mx-auto py-12 text-center">
        <h2 className="text-3xl font-semibold text-blue-900 mb-8">Explore Our QC Tools</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold text-blue-900 mb-4">DAT File Validation</h3>
            <p className="text-gray-600">Ensure the integrity of your DAT files with automated checks for metadata, hash values, and file extensions.</p>
            <img src="/dashboard-image1.png" alt="QC Tool Preview" className="mt-4 w-full rounded-lg"/>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold text-blue-900 mb-4">AI-Powered Insights</h3>
            <p className="text-gray-600">Leverage AI to uncover hidden patterns and insights in your data, saving time and ensuring accuracy.</p>
            <img src="/dashboard-image2.png" alt="QC Tool Preview" className="mt-4 w-full rounded-lg"/>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold text-blue-900 mb-4">Scalable Solutions</h3>
            <p className="text-gray-600">Scale your data review operations effortlessly while maintaining quality control across your eDiscovery process.</p>
            <img src="/dashboard-image3.png" alt="QC Tool Preview" className="mt-4 w-full rounded-lg"/>
          </div>
        </div>
      </div>
